...
var CoolTabs = function (_Component) {
  ...
  CoolTabs.prototype.renderBorderUnderTabs = function renderBorderUnderTabs() {
    ...
    return _react2.default.createElement('div', { style: _extends({}, _styles._tabsBorderBottomStyle, tabsBorderBottomStyle), className: tabsBorderBottomClassName });
  };
    ...
    switch (tabKey) {
      case '1':
        return _react2.default.createElement('div', {
          style: _extends({}, _styles._activeBorderBottomStyle, _transformBorder1, {
            transition: borderTransitionStyle
          }, activeLeftTabBorderBottomStyle),
          className: activeLeftTabBorderBottomClassName });
      case '2':
        return _react2.default.createElement('div', {
          style: _extends({}, _styles._activeBorderBottomStyle, _transformBorder2, {
            transition: borderTransitionStyle
  ...
  CoolTabs.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { style: _extends({}, _styles.buttonStyle, _styles._tabStyle, leftTabStyle, _activeTab1), className: leftTabClassName + ' ' + (tabKey === '1' ? '' + activeTabClassName : unActiveClassName),
        ...
        _react2.default.createElement(
          'button',
          { style: _extends({}, _styles.buttonStyle, _styles._tabStyle, rightTabStyle, _activeTab2), className: rightTabClassName + ' ' + (tabKey === '2' ? '' + activeTabClassName : unActiveClassName),
            onClick: function onClick() {
      ...
      _react2.default.createElement(
        'div',
        { style: _extends({}, _styles._contentContainerStyle, contentContainerStyle), className: contentContainerClassName },
        _react2.default.createElement(
          'div',
          { style: _extends({}, _styles._contentStyle, _transformContent1, leftContentStyle, {
        ...
        _react2.default.createElement(
          'div',
          { style: _extends({}, _styles._contentStyle, _transformContent2, rightContentStyle, {
              transition: contentTransitionStyle
